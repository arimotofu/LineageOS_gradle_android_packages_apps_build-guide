...
only clone repos with branches that has `build.gradle` or `build.gradle.kts`. if it doesn't, it requires the full AOSP build system and will not work standalone with this guide.
